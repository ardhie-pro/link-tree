...
<html lang="en">
    ...
    <head>
        <title>Admin - Input Prestasi</title>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="page-title-box">
                  <h4 class="page-title">Data Prestasi Siswa</h4>
                  <ol class="breadcrumb">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card m-b-20">
                    <div class="card-body">
                      <h2 class="mt-0 header-title container text-center mb-5"> Tabel Data Prestasi Siswa</h2>
                      ...
                      >
                        ...
                        <?php
                          ...
                          ?>
                            ...
                            <td><?php echo $prestasi['kelas']; ?></td>
                            <td>
                              <a class="btn btn-warning" href="editprestasi.php?id='<?php echo $prestasi['id'];?>'">Edit</a>
                            </td>
                            <td>
                              <a class="btn btn-danger" href="../mesin/hapusprestasi.php?id='<?php echo $prestasi['id'];?>'">Hapus</a>
                            </td>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0">Tambah Prestasi Siswa</h5>
